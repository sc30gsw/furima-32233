...
ActiveRecord::Schema.define(version: 2020_12_12_023325) do
  ...
  create_table "purchase_infos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.bigint "product_user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_user_id"], name: "index_purchase_infos_on_product_user_id"
  end
  ...
  add_foreign_key "purchase_infos", "product_users"
end
