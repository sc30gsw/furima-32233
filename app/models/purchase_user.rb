class PurchaseUser
  ...
  attr_accessor :postal_code, :prefecture_id, :city, :adress, :building_name, :phone_number, :product_user, :product, :user
  ...
  def save
    PurchaseInfo.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city, adress: adress, building_name: building_name, phone_number: phone_number, product_user: product_user)
    ProductUser.create(user: user, product: product)
  end
end